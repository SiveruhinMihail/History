    ...
    <div v-else>
      ...
      <div class="flex items-start gap-4 mb-6">
        ...
        <div class="flex items-center gap-2">
          ...
          <!-- Статус заявки или кнопка вступления -->
      ...
      <div v-if="tab === 'members'">
        ...
        <div v-if="userRole === 'admin' && pendingMembers.length">
          <h3 class="font-semibold mt-4 mb-2">Заявки на вступление</h3>
          <div
      ...
      <div v-if="tab === 'chat' && isMember">
        <div class="h-96 overflow-y-auto border p-2 mb-2" ref="chatContainer">
